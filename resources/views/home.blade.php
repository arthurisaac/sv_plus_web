        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        <div
                            class="icon icon-lg icon-shape bg-gradient-success shadow-secondary text-center border-radius-xl mt-n4 position-absolute">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach($alertes as $alerte)
                                    ...
                                    <tr @if ($alerte->vue == 1 ) class="bg-gradient-light" @endif>
                                        ...
                                        <td class="text-center">
                                            @if ($alerte->traite == 0) <span class="badge bg-danger">non traité</span>
                                            @elseif ($alerte->traite == 1) <span class="badge bg-warning">En cours</span>
                                            @elseif ($alerte->traite == 2) <span class="badge bg-success">Traité</span>
