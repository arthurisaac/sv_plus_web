    ...
    {{--<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route("home") }}" target="_blank">
                ...
                <span class="ms-1 font-weight-bold text-white">{{ config('app.name', 'SAUVIE ALERTE') }}</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                --}}{{--<li class="nav-item">
                    <a class="nav-link text-white " href="/chatify" target="_blank">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
                        <span class="nav-link-text ms-1">{{ __('Messagerie')}}</span>
                    </a>
                </li>--}}{{--
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route("discussions.index") }}" target="_blank">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
                        <span class="nav-link-text ms-1">{{ __('Chats')}}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('me.notifications') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <span class="nav-link-text ms-1">{{ __("Déconnexion") }}</span>
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="container-fluid ps-2 pe-0">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="{{ route('discussions.index') }}">
                                        <i class="fas fa-comment opacity-6 text-dark me-1"></i>
                                        {{ __("Discussions") }}
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="{{ route('me.notifications') }}">
                                        <i class="fas fa-bell opacity-6 text-dark me-1"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item dropdown pe-2 d-flex align-items-center">
                           {{-- <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="{{ route("me.notifications") }}">
